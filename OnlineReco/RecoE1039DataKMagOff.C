...
int RecoE1039DataKMagOff(const int run_id, const std::string DST_in="data.root", const int nEvents = 0)
...
/********************************************/
  ...
  rc->set_CharFlag("AlignmentMille", "alignment/align_mille_v09.txt"); // Using custom alignment according to the residue plots
...
/********************************************/
  // The residue distribution for some of D0 and D2 planes are obviously cut
  rc->set_DoubleFlag("RejectWinDC0", 0.3);
  rc->set_DoubleFlag("RejectWinDC2", 0.6);
