...
def main():
    ...
    tape_loc = '/pnfs/e1039/scratch/users/ckuruppu/tape_backed/decoded_data/'
    #abspath = os.getcwd()
    #abspath = '/seaquest/users/ckuruppu/SemiOnlineReconstruction2/'
    abspath = os.path.dirname(os.path.abspath(__file__))
    print(f"Absolute Path set to: {abspath}")
    ...
    # K-Mag On Runs
    #new_runs = [5846, 5847, 5848, 5991, 5992, 5994, 5995, 6032, 6033, 6034, 6036, 6037, 6038, 6039, 6040, 6041, 6042, 6043, 6044, 6045, 6046, 6047, 6048, 6049, 6052, 6053, 6054, 6055,  6056, 6057, 6058, 6069, 6070, 6071, 6094, 6097, 6099, 6111, 6112, 6113, 6114, 6115, 6116, 6117, 6118, 6135, 6136, 6137, 6138, 6139, 6140, 6142, 6143, 6144, 6145, 6146, 6149, 6150, 6151, 6152, 6153, 6154, 6155, 6156]
