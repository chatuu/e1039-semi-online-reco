...
time root -l -b -q "RecoE1039DataKMagOn.C("$run_number", \"data.root\", "$nevents")";
#time root -l -b -q "RecoE1039DataKMagOff.C("$run_number", \"data.root\", "$nevents")";
#time root -l -b -q "RecoE1039Data.C(\"data.root\")";
RET=$?
if [ $RET -ne 0 ] ; then
